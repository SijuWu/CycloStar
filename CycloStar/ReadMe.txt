========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet CycloStar
========================================================================

AppWizard a créé cette application CycloStar pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application CycloStar.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé CycloStar.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
